...
*/
...
#ifdef __APPLE__
    #ifndef __MACH__
        #define XS_KERN_OS_APPLE
        #define XS_KERN_OS 1
    #else
        #define XS_KERN_OS -1 // os 9
    ...
    #define XS_KERN_OS_LINUX
    #ifndef __ANDROID__
        #define XS_KERN_OS 2 // linux
    #else
        #define XS_KERN_OS_ANDROID
        #define XS_KERN_OS 3 // android (linux)
    #endif
#endif

#ifdef _WIN32
    // TODO check that were using windows 7 or greater
    #define XS_KERN_OS_WIN
    #define XS_KERN_OS 0
#endif
